...
describe("home backend cleanup", () => {
  it("removes dead code and high-volume debug logs from home loading paths", () => {
    ...
    const editorHookSource = readFileSync("components/timeline-v2/useTimelineEditor.ts", "utf8");
    ...
    expect(editorHookSource).not.toContain("openMonthlyAllocationConfirm");
