 ...
 * Proxy endpoint for fetching employees from MySQL API
 */
export async function GET(request: Request) {
  try {
    ...
    if (response.error) {
      console.error('[MySQL Bridge] Employees API error:', response.error);
    ...
    console.error('Failed to fetch MySQL employees:', error);
